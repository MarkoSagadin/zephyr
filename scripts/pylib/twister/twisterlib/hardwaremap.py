...
class HardwareMap:
    ...
    def discover(self):
        ...
        if self.options.device_testing:
            ...
            # TODO: this part is weird from api point, you shouldn't passing the first
            # parameter in this way, adding rtt doesn't fit into this logic
                ...
                # RTT always requires flashing before connecting
