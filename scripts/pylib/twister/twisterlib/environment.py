...
Artificially long but functional example:
   ...
   "kernel.fifo.poll" is one of the test section names in
    ...
    parser.add_argument("--rtt-runner",
                        help="""Uses the specified west rtt runner instead of default 
                        when running with --device-rtt.

                        E.g "twister --device-testing --device-rtt --west-runner=jlink"
                        will translate to "west flash --runner jlink"
                        """)
